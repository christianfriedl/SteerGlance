...
var customerDao = require('app/customer/CustomerDao.js');

function CustomerBo(p_db) {
    console.log('customerbo pdao', p_db);
    m_bo.BO.call(this, p_db);
    this._className = 'customerBo.CustomerBo';
    this.dao(customerDao.customerDao(p_db));
};
