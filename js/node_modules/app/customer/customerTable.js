...
CustomerTable.prototype.addLinks = function(invoiceTable) {
    this.field('id').link(invoiceTable.field('customerId'), m_sql_fieldLink.fieldLink(this.field('id'), invoiceTable.field('customerId'), m_sql_fieldLink.Type.oneToMany));
