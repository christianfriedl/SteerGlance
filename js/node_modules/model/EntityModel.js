...
EntityModel.prototype.setTable = function(/* sql_Table.Table */ table) {
    ...
    console.log('after set table, fields of table', this._table.getName(), ' in entitymodel are', this._table.getFieldsAsList());
};
