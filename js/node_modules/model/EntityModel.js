...
EntityModel.prototype.isValid = function() {
    // validate will throw on failure
    return this.validate().then(() => { return true; }).catch ((e) => {
        // TODO return message somehow...??
        return false;
    });
};
...
EntityModel.prototype.validate = function() {
    // TODO which fields do we want to validate?
    return q.all(_.map(this._table.getPersistentFields(), (field) => { field.getValue().then((value) => { field.validate(value); }); }));
};
...
EntityModel.prototype.getAttribute = function(name) {
