...
function Form(data, cssId) {
    ...
    this._data = data;
    this._cssId = cssId;
    if ( typeof(window.SteerGlance) === 'undefined' ) {
        window.SteerGlance = { forms: {} };
    }
    if ( typeof(window.SteerGlance.forms[this._id]) !== 'undefined' ) { console.log('nonu', window.SteerGlance.forms[this._id]); throw new Error('id not unique'); }
    window.SteerGlance.forms[this._id] = this;
}
...
Form.prototype._thisFormHtml = function() {
    return 'window.SteerGlance.forms[\'' + this._id + '\']';
};
