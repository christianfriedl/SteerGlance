...
BO.prototype.fieldsToJson = function() {
    return _(this.fieldsAsList()).map(function(f) { return f.toJson(); });
};

BO.prototype.calcFieldsToJson = function() {
    return _(this.calcFieldsAsList()).map(function(f) { return f.toJson(); });
};
