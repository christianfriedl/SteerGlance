...
function PrimaryBo(/*dao_dao*/p_dao) {
    if ( arguments.length > 0 ) {
        /* ifdef DEVELOPMENT */ if ( arguments.length !== 1 || p_dao === undefined ) { throw new Error('Illegal argument length'); }
...
PrimaryBo.prototype.saveField = function(fieldName, row, callback, /*[{ autoSave: [bool true] }]*/options) {
    ...
    if ( opts.autoSave ) {
        ...
        return this.save(function(err, bo) { return callback(err, this, { hasSaved: true, hasInserted: shouldInsert } ); });
    } else {
...
function primaryBo(p_db, p_dao) { return new PrimaryBo(p_db, p_dao); }
