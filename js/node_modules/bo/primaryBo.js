...
PrimaryBo.prototype.saveField = function(/*string */ fieldName, /* object{name: value,...} */ row, callback, /*[{ autoSave: [bool true] }]*/ options) {
    ...
    console.log('pb savefield row', row, 'fn', fieldName);
    if ( _(_(row.fields).keys()).any(function(k) { return ( ( this.field(k).isRequired() ) && ( typeof(row.fields[k]) === 'undefined' || row.fields[k].length === 0 ) ); }.bind(this)) ) {
