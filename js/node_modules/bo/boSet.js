...
function BoSet(/* m_sql_db.DB */ p_db, /*dao_daoSet*/ p_daoSet, /*(optional)bo_bo function()*/ p_constructor) {
    ...
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            ...
            var PARAM = p_daoSet; if ( !(PARAM instanceof m_dao_daoSet.DaoSet) ) { throw new Error('typecheck failed on ' + PARAM + ': ' + PARAM); } 
            var PARAM = p_constructor; if ( !(PARAM instanceof Function) ) { throw new Error('typecheck failed on ' + PARAM + ': ' + PARAM); } 
        /* @DEVELOMPENT } */
        this._db = p_db;
