...
function BoSet(/* m_sql_db.DB */ db, /*dao_daoSet*/ daoSet, /*(optional)bo_bo function()*/ constructor) {
    ...
    if ( arguments.length > 0 ) {
        ...
        this._calculateDetailCalcFields = false;
        this._calculateAggregatedCalcFields = false;
    } 
...
BoSet.prototype.calculateDetailCalcFields = function(calculateDetailCalcFields) {
    if ( typeof(calculateDetailCalcFields) !== 'undefined' ) {
        this._calculateDetailCalcFields = calculateDetailCalcFields;
        return this;
    }
    return this._calculateDetailCalcFields;
};

BoSet.prototype.calculateAggregatedCalcFields = function(calculateAggregatedCalcFields) {
    if ( typeof(calculateAggregatedCalcFields) !== 'undefined' ) {
        this._calculateAggregatedCalcFields = calculateAggregatedCalcFields;
        return this;
    }
    return this._calculateAggregatedCalcFields;
};
...
BoSet.prototype.loadAllByConditions = function(/* m_sql_conditionSet.ConditionSet */ conditions, /* Function */ callback) {
    ...
    var calculateDetailCalcFields = this._calculateDetailCalcFields && ( this._constructor.call({}) instanceof m_bo_primaryBo.PrimaryBo );
    this._daoSet.calculateDetailCalcFields(calculateDetailCalcFields)
        .calculateAggregatedCalcFields(this._calculateAggregatedCalcFields);
    this._daoSet.loadAllByConditions(conditions, function(err, daos, aggregateDao) {
        ...
        if ( this._calculateAggregatedCalcFields ) {
