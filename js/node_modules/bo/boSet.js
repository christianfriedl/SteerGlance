...
function BoSet(/* m_sql_db.DB */ p_db, /*dao_daoSet*/ p_daoSet, /*(optional)bo_bo function()*/ p_constructor) {
    ...
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            ...
            if ( !(p_daoSet instanceof m_dao_daoSet.DaoSet) ) { throw new Error('Typecheck failure: p_daoSet should be of class m_dao_daoSet.DaoSet: ' + p_daoSet); }
            if ( !(p_constructor instanceof Function) ) { throw new Error('Typecheck failure: p_constructor should be of class Function: ' + p_constructor); }
        /* @DEVELOMPENT } */
        this._db = p_db;
...
function boSet(/* m_sql_db.DB */ p_db, /*dao_daoSet*/ p_daoSet, /*(optional)bo_bo function()*/ p_constructor) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            ...
            if ( !(p_constructor instanceof Function) ) { throw new Error('Typecheck failure: p_constructor should be of class Function: ' + p_constructor); }
        /* @DEVELOMPENT } */
        return new BoSet(p_db, p_daoSet, p_constructor);
    } else {
        return new BoSet();
    }
...
/*bo.BO*/BoSet.prototype.templateBo = function() {
    return this._constructor.call({}).dao(this._daoSet.templateDao()); 
};
