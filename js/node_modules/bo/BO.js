...
var BO = function(/*dao_dao*/p_dao) {
    ...
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */ 
            if ( arguments.length !== 1 ) { throw new Error('Illegal argument length'); }
            var PARAM = p_dao; if ( !(PARAM instanceof m_dao.DAO) ) { throw new Error('typecheck failed on ' + PARAM + ': ' + PARAM); }  
        /* @DEVELOMPENT } */
        this._fields = {};
        this.dao(p_dao);
    }
