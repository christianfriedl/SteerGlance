 ...
 */
BO.prototype.loadById = function(id, callback, calculateCalcFields) {
...
BO.prototype.loadAllByConditions = function(conditions, callback, calculateCalcFields) {
    ...
    console.log('calculateCalcFields in loadAllByConditions BO', calculateCalcFields);
    this._dao.loadAllByConditions(conditions, function(err, daos) {
        if (err) return callback(err);
        console.log('#### labc', daos);
