...
Server.prototype._getActionMethod = function(routeDesc) {
    ...
    const controllerDir = deps._.find([ 'app/web/server', 'web/server/controller' ], ( dir ) => {
    ...
    const controllerModule = require(controllerDir + '/' + controllerFileName);


    const controllerObject = controllerModule.create(this._config);
    const method = controllerObject[this._getActionMethodName(routeDesc.actionName)].bind(controllerObject);
