...
function create(/* model_EntityModel.Entity */ model) {
    ...
    if ( arguments.length > 0 ) {
        /* @DEVELOMPENT { */
            if ( !(model instanceof model_EntityModel.EntityModel) ) { throw new Error('model must be of type model_EntityModel.EntityModel'); }
        /* @DEVELOMPENT } */
...
/* Promise(Object) */ Entity.prototype.getValuesAsObject = function(/* optional Array(String) */ names) {
    if ( names === undefined ) {
