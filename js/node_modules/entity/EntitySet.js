...
EntitySet.prototype.setModel = function(/* model_EntitySetModel.EntitySetModel */ model) {
    /* @DEVELOMPENT { */
        if ( !(model instanceof model_EntitySetModel.EntitySetModel) ) { throw new Error('model must be of type model_EntitySetModel.EntitySetModel'); }
    /* @DEVELOMPENT } */
    this._model = model;
...
EntitySet.prototype.findEntities = function(/* sql_ConditionSet */ conditionSet) { 
...
/**
 * entity_Entity.create: function create(model_EntityModel.Entity model);
 * this._model.createEntityModel can create the entity model
    this._entityConstructor can create the entity from the entity model
 */
/* entity_Entity.Entity */ EntitySet.prototype.createEntity = function() {
