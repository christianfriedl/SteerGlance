...
function DaoSet(/*sql_db*/p_db, /*sql_table*/p_table, /*function*/p_constructor) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT */ if ( arguments.length !== 3 || p_constructor === undefined ) { throw new Error('Illegal arguments length'); }
...
/*dao.DAO*/ DaoSet.prototype.templateDao = function() {
    return this._constructor.call({}, this._db, this._table);
};
...
DaoSet.prototype.loadAllByQuery = function(query, callback) {
    ...
    this._db.fetchAll(query, function(err, rows) {
        ...
        _(rows).each(function(row) {
            console.log('loadAllByQuery db is', self._db, 'constructor is', self._constructor.toString());
                ...
                async.each(daos, 
                    function(dao, callback2) {
                        ...
                        async.parallel([
                            ...
                            function(callback3) { 
                                if (!dao._db) { console.log('calling pop without db'); debugger; }
...
function daoSet(/*sql_db*/p_db, /*sql_table*/p_table, /*function*/p_constructor) { if ( arguments.length > 0 ) { return new DaoSet(p_db, p_table, p_constructor); } else { return new DaoSet(); } }
