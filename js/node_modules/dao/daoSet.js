...
function DaoSet(/*m_dao_daoFactory.DaoFactory*/ p_daoFactory, /*m_sql_table.Table|null*/ p_table, /*Function*/ p_constructor) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT */ 
            if ( arguments.length !== 3 || p_constructor === undefined ) { throw new Error('Illegal arguments length'); }
...
function daoSet(/*m_dao_daoFactory.DaoFactory*/ p_daoFactory, /*sql_table*/ p_table, /*function*/ p_constructor) { if ( arguments.length > 0 ) { return new DaoSet(p_daoFactory, p_table, p_constructor); } else { return new DaoSet(); } }
