...
DAO.prototype.loadAllByConditions = function(conditions, callback) {
    ...
    return this.loadAllByQuery(q, callback);
};

DAO.prototype._setValuesFromCalcFields(conditions) {
    _(this._fields).each(function(f) {
        if ( f instanceof m_sql_calcField.CalcField ) {
