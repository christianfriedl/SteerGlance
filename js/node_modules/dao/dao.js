...
DAO.prototype.table = function(table) {
    ...
    if ( typeof(table) !== 'undefined' ) {
        m_dao_daoDataProvider.DaoDataProvider.prototype.table.call(this, table);
        this._addAccessors();
        return this;
    }
    return this._table;
...
DAO.prototype.fieldValuesFromBo = function(bo) {
    _(this.databaseFieldsAsList()).each( function(f) { 
...
DAO.prototype.loadByQuery = function(query, callback) {
    this._db.fetchRow(query, function(err, row) {
        ...
        if ( this._willPopulateLookupFields ) {
...
DAO.prototype.calculateCalcFields = function(filters, callback) {
...
DAO.prototype.populateLookupFields = function(callback) {
    async.each(this.lookupFieldsAsList(), function(f, callback) {
        return this.populateLookupField(f, callback);
    }.bind(this), function(err) {
        callback(err, this);
    }.bind(this));
};

DAO.prototype.populateLookupField = function(/* m_sql_lookupField.LookupField */ field, /* Function */ callback) {
    /* @DEVELOPMENT { */
        if ( arguments.length !== 2 ) { throw new Error('Illegal argument length '  + arguments.length + ', should be ' + 2); }
        if ( !(field instanceof m_sql_lookupField.LookupField) ) { throw new Error('Typecheck failure: field should be of class m_sql_lookupField.Loo: ' + field); }
    /* @DEVELOMPENT } */
    ...
    this._db.fetchAll(q, function(err, rows) {
        ...
        _(rows).each(function(row) {
            field.addOption(row[field.labelFieldName()], row[field.valueFieldName()]);
        }.bind(this));
