...
PrimaryDao.prototype._amendTable = function() {
    if ( typeof(this._table.field('id')) === 'undefined' ) {
        var idField = field.field('id', field.DataType.int);
        idField.isEditable(false);
        this._table.field(idField);
    }
};
...
function primaryDao(p_db, p_table) { if ( arguments.length > 0) { return new PrimaryDao(p_db, p_table); } else { return new PrimaryDao(); } }
