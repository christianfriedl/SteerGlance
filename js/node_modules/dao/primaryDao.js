...
PrimaryDao.prototype.loadById = function(id, callback, calculateCalcFields) {
    ...
    this._db.fetchRow(q, function(err, row) { 
        ...
        if ( calculateCalcFields ) {
            this._calculateCalcFields(m_sql_condition.condition(this.field('id'), m_sql_condition.Op.eq, id), function(err, row) {
...
PrimaryDao.prototype._createIdWhere = function() {
    console.log('_createIdWhere', condition.condition(this._fields['id'], condition.Op.eq, this._fields['id'].value()));
