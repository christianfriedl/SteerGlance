    ...
    http.createServer(function(request, response) {
        ...
        function handle(request, response) {
            ...
            router.route(request, function(err, moduleName, controllerName, actionName, query) {
                ...
                serveRequest(db1, request, moduleName, controllerName, actionName, query, responseCallback);
            });
        }
    }).listen(8888);
}
 ...
 */
function serveRequest(db, origRequest, moduleName, controllerName, actionName, query, responseCallback) {
        var internalRequest = { 
            db: db, 
