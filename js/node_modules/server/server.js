...
function start() {
    ...
    http.createServer(function(request, response) {
        ...
        router.route(request, function(err, moduleName, controllerName, actionName, query) {
            ...
            var internalRequest = { db: db1, moduleName: moduleName, controllerName: controllerName, actionName: actionName, request: request, url: request.url, query: query };
            var internalResponse = { request: internalRequest, returnCode: 200, contentType: 'text/html', text: '', response: response };
