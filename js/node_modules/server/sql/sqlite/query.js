...
Query.prototype._updateQueryString = function() {
    var sql = 'UPDATE ';
    sql += _.map(this._serverQuery.table().fields(), function(field) { this._params.push(field.value()); return field.name() + ' = ?'; }.bind(this)).join(', ');

    var conditions = this._serverQuery.conditions();
