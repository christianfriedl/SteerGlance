...
/** setter */
/* void */ TableFieldManager.prototype.field = function(/* m_sql_fieldDescriptor.FieldDescriptor */ fieldDescriptor) {
...
TableFieldManager.prototype.apply = function() {
    ...
    _(_(this._descriptors).filter( (desc) => {
        ...
        links.push(m_lazyCalcFieldLink.lazyCalcFieldLink(this._table, desc.name, desc.byFieldName, desc.sumTableName, desc.sumFieldName));
    });
    ...
    _(_(this._descriptors).filter( (desc) => {
        ...
        links.push(m_lazyLookupFieldLink.lazyLookupFieldLink(..... desc));
    });
    */
