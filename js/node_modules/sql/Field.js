...
/**
 * @property {Boolean} isPersistent Is this Field reflected directly in the DB?
 */
Field.prototype.isPersistent = true;
/**
 * @property {Boolean} isEditable Can this Field be edited by the user?
 */
Field.prototype.isEditable = true;
/**
 * @property {Boolean} isRequired Does this Field have to be set before saving?
 */
