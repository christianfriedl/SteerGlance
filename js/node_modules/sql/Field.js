...
Field.prototype.clone = function() {
    ...
    f.isPersistent(this._isPersistent);
...
/**
 * isValid will return a boolean for whether the value entered is valid or not
 */
Field.prototype.isValid = /*void*/function(value, ctx) {
    throw new Error('this is not yet async');
    try {
