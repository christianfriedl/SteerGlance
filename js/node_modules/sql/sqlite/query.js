...
Query.prototype._fieldRefOrValue = function(fieldOrValue) {
    if ( typeof(fieldOrValue.className) !== 'undefined' && (fieldOrValue.className() === 'sql.Field' || fieldOrValue.className() === 'sql.CalcField') ) {
...
Query.prototype._isField = function(fieldOrValue) {
    return ( typeof(fieldOrValue._className) !== 'undefined' && (fieldOrValue.className() === 'sql.Field' || fieldOrValue.className() === 'sql.CalcField') ); 
};
