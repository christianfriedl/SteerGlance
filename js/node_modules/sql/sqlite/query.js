...
Query.prototype._fieldRefOrValue = function(fieldOrValue) {
    if ( typeof(fieldOrValue.className) !== 'undefined' && (fieldOrValue.className === 'sql.LookupField' || fieldOrValue.className() === 'sql.Field' || fieldOrValue.className() === 'sql.CalcField') ) {
