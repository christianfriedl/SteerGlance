...
Query.prototype._orderByClause = function() {
    if ( this._sqlQuery.orderBy() !== null )  {
        return 'ORDER BY ' + _(this._sqlQuery.orderBy().getFields()).reduce(function(memo, o) { return (memo === '' ? '' : ', ') + this._orderByStuff(o); }.bind(this), '') + ' ';
    } else {
        return ' ';
    }
};
