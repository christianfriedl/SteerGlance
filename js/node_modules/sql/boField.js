...
function BoField(/*String*/ name, /* Object */ value, /*[String]*/ label, /* m_sql_db.DB */ db, /* Function */ constructor, /* m_sql_field.Field */ idField) {
    ...
    if ( arguments.length > 0 ) {
        ...
        /* @DEVELOMPENT } */
        m_sql_field.Field.call(this, name, m_sql_field.DataType.bo, value, label); // TODO take datatype from ... wherever...
 ...
 * - this is to avoid having to set our id field after the fact of our construction
 */
...
BoField.prototype._boFromIdField = function() {
    ...
    console.log('_boFromIdField idField is', this._idField);
    this._bo.loadById(this._idField.value(), function(err, bo2) {
        console.log('loaded bo ', bo2);
    });
    console.log('bo._boFromIdField called', this._constructor, this._bo);
};
...
BoField.prototype.value = function(bo) {
    ...
    console.log('bofield value got called with bo', bo);
