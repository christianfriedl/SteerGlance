 ...
 * @static
 * @method create
 * @param name name of his field
 * @param idField field that contains the id that we use for the summing
 * @param entitySetModel set model of the "other" entity
 * @param referencedIdField idField inside the "other" entity
 * @param aggregatedField the field that we will e summ'ing over
 * @param label Label
 *
 * ex.:
 *      customer.sumInvoiceAmount => invoice.sum
 *
 *      create(
 *              (name)              'sumInvoiceAmount',
 *              (idField)           customerIdField,
 *              (entitySetModel)    invoiceSetModel,
 *              (referencedIdField) invoiceIdField,
 *              (aggregatedField)   invoiceIdSum,
 *              (label)             'Sum Invoice Amount'
 *      )
 */
...
SumField.prototype.getAggregatedField = function() {
    return this._aggregatedField;
};
SumField.prototype.setAggregatedField = function(/* sql_Field */ aggregatedField) {
...
SumField.prototype.getValue = function() {
    return this._idField.getValue().then( (id) => {
        ...
        const query = sql_Query.select()
            .setFields([ sql_Aggregate.sum(this._aggregatedField) ])
