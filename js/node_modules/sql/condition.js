...
Condition.prototype.compareToValue = function() {
    if ( typeof(this._compareTo.className()) !== 'undefined' && this._compareTo.className() === 'sql.Field' ) {
...
function conditionsFromWeb(p_table, p_requestConditions) {
    ...
    return _(p_requestConditions).map(function(c) {
        return m_sql_condition.condition(p_table.field(c.fieldName), m_sql_condition.opFromName(c.opName), c.value);
}
