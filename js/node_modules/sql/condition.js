...
function Condition(p_field, p_op, p_compareTo) {
    ...
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT */ if ( arguments.length !== 3 ) { throw new Error('Illegal argument length '  + arguments.length + ', should be ' + 3); }
        /* @DEVELOPMENT */ if ( !(p_field instanceof m_sql_field.Field) ) { throw new Error('typecheck failed on p_field'); }
        /* @DEVELOPMENT */ if ( !(util.isString(p_op)) ) { throw new Error('typecheck failed on p_op'); }
