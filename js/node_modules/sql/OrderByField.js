...
var sql_OrderBy = require('sql/OrderBy.js');

function OrderByField(/*sql_Field.Field */ field, /* sql_OrderBy.Direction */ direction) {
    bjoo.BJOObject.apply(this);

    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            if ( arguments.length !== 2 ) { throw new Error('Illegal argument length '  + arguments.length + ', should be ' + 2); }
            if ( !(field instanceof sql_Field.Field) ) { throw new Error('Typecheck failure: field should be of class sql_field.Field: ' + field); }
        /* @DEVELOMPENT } */
...
function create(/*sql_Field.Field */ field, /* sql_OrderBy.Direction */ direction) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            if ( arguments.length !== 2 ) { throw new Error('Illegal argument length '  + arguments.length + ', should be ' + 2); }
            if ( !(field instanceof sql_Field.Field) ) { throw new Error('Typecheck failure: field should be of class sql_field.Field: ' + field); }
...
OrderByField.prototype.setField = function(/* sql_Field.Field */ field) {
    this._field = field;
    return this;
};
