...
function lookupField(/* String */ name, /* object */ value, /* String */ label, /* m_sql_field.Field */ targetField, /* m_sql_field.Field */ targetLabelField) {
    if ( arguments.length > 0 ) {
        ...
        if ( arguments.length === 3) { 
            return new LookupField(name, value, label);
        } else {
...
LookupField.prototype.link = function(/* optional m_sql_field.Field */ fieldOrLink) {
    ...
    if ( arguments.length === 1 ) {
        ...
        /* @DEVELOMPENT } */
        if ( fieldOrLink instanceof m_sql_field.Field ) {
            this._link = m_sql_fieldLink.fieldLink(this, fieldOrLink, m_sql_fieldLink.Type.manyToOne);
        } else {
            this._link = fieldOrLink;
        }
        console.log('### testLookups _link is', util.inspect(this._link), 'from' , util.inspect(fieldOrLink));
        return this;
    } else {
        return this._link;
    }
...
/*Object*/LookupField.prototype.webize = function() {
    console.log('#### webize', util.inspect(this));
    return { 
