...
function orderByFromWeb(/* m_sql_table.Table */ table, /* Array */ webOB) {
    /* @DEVELOPMENT { */
        ...
        if ( !(arguments.length === 1 || webOB instanceof Array) ) { throw new Error('Typecheck failure: webOB should be of class Array: ' + webOB); }
    /* @DEVELOMPENT } */
    ...
    console.log('orderByFromWeb sees webOB', webOB);
    _(webOB).each(function(w) { console.log('orderByFromWeb sees w', w); ob.addField(field(table.field(w.field), directionByName(w.direction))); });
    return ob;
}
