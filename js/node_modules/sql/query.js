...
Query.prototype.fields = function(fields) {
    if ( typeof(fields) !== 'undefined' ) {
        /* #ifdef DEVELOPMENT */if (!(fields instanceof Array)) throw new Error('fields must be an array');
        this._fields = fields;
        return this;
    }
    return this._fields;
...
Query.prototype.conditions = function(conditions) {
...
Query.prototype.into = function(table) {
    this._tables = [ table ];
    this.fields(table.fieldsAsList());
    return this;
};
 ...
 * --- will add to current conditions (which are ANDed... TODO we don't have OR yet)
 */
Query.prototype.where = function() {
    /* #ifdef DEVELOPMENT */if (arguments.length === 1 && arguments[0] instanceof Array) throw new Error('arguments to query.where() are not supposed to be an array');
    this._conditions = _(this._conditions).union(Array.prototype.slice.call(arguments));
    return this;
};
