...
const Type = { select: 'select', update: 'update', 'delete': 'delete', insert: 'insert' };
...
/* this/object */ Query.prototype.conditions = function(/* optional m_sql_conditionSet */ conditions) {
    if ( typeof(conditions) !== 'undefined' ) {
        ...
        if ( typeof(conditions.getLimit()) !== 'undefined' ) {
            this.limit(conditions.getLimit());
        }

        if ( typeof(conditions.getOffset()) !== 'undefined' ) {
            this.offset(conditions.getOffset());
        }

        if ( typeof(conditions.getOrderBy()) !== 'undefined' ) {
            this.orderBy(conditions.getOrderBy());
        }
        return this;
    }
