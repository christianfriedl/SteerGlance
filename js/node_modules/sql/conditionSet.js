...
function ConditionSet(/* [array(m_sql_filter.Filter)] = [] */ filters, /* [int] = null */ limit, /* [int] = null */ offset, /* [....?] = null */ orderBy) {
    ...
    this._className = 'sql.ConditionSet';
    ...
    console.log('condistion set is ' , this);
}
...
ConditionSet.prototype.filters = function(filters) {
    if ( typeof(filters) !== 'undefined' ) {
        this._filters = filters;
        return this;
    }
...
ConditionSet.prototype.limit = function(limit) {
    if ( typeof(limit) !== 'undefined' ) {
        this._limit = limit;
        return this;
    }
...
ConditionSet.prototype.offset = function(offset) {
    if ( typeof(offset) !== 'undefined' ) {
        this._offset = offset;
        return this;
    }
...
ConditionSet.prototype.orderBy = function(/* array(field) */ orderBy) {
 ...
 */
var conditionSetFromWeb = function(/* m_sql_table.Table */ table, /* object */ webCS) {
    /* @DEVELOPMENT { */
    ...
    return new ConditionSet(m_sql_filter.filtersFromWeb(table, webCS.filters), webCS.limit, webCS.offset, m_sql_orderBy.orderByFromWeb(table, webCS.orderBy));
};

exports.ConditionSet = ConditionSet;
exports.conditionSet = conditionSet;
exports.conditionSetFromWeb = conditionSetFromWeb;
