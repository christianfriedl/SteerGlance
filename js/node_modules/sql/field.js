...
var DataType = { int: 'int', string: 'string', bo: 'bo' }
...
Field.prototype.onAfterAddToDao = function(/* m_dao_dao.DAO */ dao) {
    _(_(this._links).values()).each(function(l) {
        l.sourceField(dao.field(l.sourceField().name()));
        l.targetField(dao.field(l.targetField().name()));
    });
};
