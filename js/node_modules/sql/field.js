...
/* String */ Field.prototype.id = function(/* void */) {
    return this._id;
};
...
Field.prototype.isDatabaseField = function(isDatabaseField) {
	if ( typeof(isDatabaseField) !== 'undefined' ) {	
...
/*m_sql_fieldLink.FieldLink/this*/Field.prototype.link = function(/*m_sql_fieldLink.FieldLink / m_sql_table.Table*/linkOrTable) {
    /* @DEVELOPMENT { */
        ...
        if ( arguments.length === 1 ) {
            if ( !(linkOrTable instanceof m_sql_fieldLink.FieldLink || linkOrTable instanceof m_sql_table.Table) ) { throw new Error('Typecheck failure: link should be of class FieldLink or Table: ' + link); }
        }
    /* @DEVELOMPENT } */
