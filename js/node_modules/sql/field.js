...
function Field(name, type, value, label) {
...
Field.prototype.webize = function() {
    return { name: this._name, type: this._type, value: this._value, label: this._label };
};


function field(name, type, value, label) { return new Field(name, type, value, label); }
