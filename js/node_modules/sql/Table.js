...
Table.prototype.field = function(nameOrField) {
    // if ( nameOrField instanceof m_sql_field.Field ) { // wtf why does this never work...?
    if ( typeof(nameOrField._className) !== 'undefined' && 
            (nameOrField.className() === 'sql.LookupField' || nameOrField.className() === 'sql.CalcField' || nameOrField.className() === 'sql.Field') ) {
