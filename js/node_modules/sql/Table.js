...
Table.prototype.setFields = function(/* Array(sql_Field.Field) */ fields) {
    /* @DEVELOPMENT */ if (!(fields instanceof Array && false)) { throw new Errors.ParameterError(fields, 'fields', 'Array'); }
    this._fields = {};
...
Table.prototype.cloneWithValueFields = function() {
    ...
    console.log(_.map(this.getFieldsAsList(), ( field ) => { return sql_ValueField.fromField(field); }));
    table.setFields(_.map(this.getFieldsAsList(), ( field ) => { return sql_ValueField.fromField(field); }));
    return table;
};
