...
Table.prototype.clone = function() {
    ...
    console.log('in table.clone, fields are', this.getFieldsAsList());
    table.setFields(_.map(this.getFieldsAsList(), ( field ) => { console.log('field.clone is', field.clone()); return field.clone(); }));
    console.log('fields after table clone', table._fields);
    return table;
};
