 ...
 */
function BoSetField(/*String*/name, /* m_bo_boSet.BoSet */ value, /*String*/label, /* m_sql_fieldLink.FieldLink */ fieldLink, /* object { moddule, controller, action} */ frontendOptions) {
...
function BoSetField(/*String*/name, /* m_bo_boSet.BoSet */ value, /*String*/label, /* m_sql_fieldLink.FieldLink */ fieldLink, /* object { moddule, controller, action} */ frontendOptions) {
    if ( arguments.length > 0 ) {
        return new BoSetField(name, value, label, fieldLink, frontendOptions);
    } else {
...
BoSetField.prototype.clone = function() {
    var f = new BoSetField(this._name, this._value, this._label, this._fieldLink, this._frontendOptions);
