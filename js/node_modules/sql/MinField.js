...
exports.MinField = MinField;
exports.create = create;

MinField.prototype = new sql_Field.Field();
MinField.prototype.constructor = MinField;

MinField.prototype.clone = function() {
...
MinField.prototype.getIdField = function() {
    return this._idField;
};
MinField.prototype.setIdField = function(/* sql_Field */ idField) {
    this._idField = idField;
    return this;
};

MinField.prototype.getEntitySetModel = function() {
    return this._entitySetModel;
};
MinField.prototype.setEntitySetModel = function(/* model_EntitySetModel.EntitySetModel */ entitySetModel) {
    this._entitySetModel = entitySetModel;
    return this;
};

MinField.prototype.getReferencedIdField = function() {
    return this._referencedIdField;
};
MinField.prototype.setReferencedIdField = function(/* sql_Field */ referencedIdField) {
    this._referencedIdField = referencedIdField;
    return this;
};

MinField.prototype.getAggregatedField = function() {
    return this._aggregatedField;
};
MinField.prototype.setAggregatedField = function(/* sql_Field */ aggregatedField) {
 ...
 */
MinField.prototype.getValue = function() {
    return this._idField.getValue().then( (id) => {
        ...
        const query = sql_Query.select()
            .setFields([ sql_Aggregate.min(this._aggregatedField) ])
...
MinField.prototype.updateReferences = function() {
