...
function FieldLink(sourceField, targetField, type) {
    if ( arguments.length > 0 ) {
        ...
        if ( !(sourceField instanceof m_sql_field.Field) ) { throw new Error('Typecheck failure: sourceField should be of class m_sql_field.Field: ' + sourceField); }
        if ( !(targetField instanceof m_sql_field.Field) ) { throw new Error('Typecheck failure: targetField should be of class m_sql_field.Field: ' + targetField); }
...
FieldLink.prototype.type = function(type) {
    if ( typeof(type) !== 'undefined' ) {
        /* @DEVELOPMENT { */ if ( ! _(Type).contains(type) ) { throw new Error('unknown fieldLink.Type ' + type); } /* @DEVELOMPENT } */
        this._type = type;
        return this;
    }
    return this._type;
...
FieldLink.prototype.toJson = function() {
