...
var sql_OrderByField = require('sql/OrderByField.js');
...
/**
 * we accept as argument an array of sql_OrderBy.OrderByField, NOT sql_Field.Field!!!
 */
...
function fromWeb(/* sql_table.Table */ table, /* Array */ webOB) {
    /* @DEVELOPMENT { */
        if ( arguments.length < 1 ) { throw new Error('Illegal argument length '  + arguments.length + ', should be ' + 1); }
