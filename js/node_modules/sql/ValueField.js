...
/**
 * ValueField: A field that holds an object as a value
 * @class sql.ValueField
 * @extends sql.Field
 * @constructor
 * @param {String} name
 * @param {sql_Field.DataType} dataType
 * @param {String} [label]
 * @param {Object} [value]
 */
...
ValueField.prototype.clone = function() {
    const f = create(this._name, this._dataType, this._label, this._value);
...
// @pure
/* Promise(Object) */ ValueField.prototype.toJson = function() {
    return q({ 
