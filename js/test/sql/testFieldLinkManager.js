...
var m_sql_fieldLinkManager = require('sql/fieldLinkManager.js');
...
var tests = {
    ...
    testCreate: function() {
        ...
        var mgr1 = m_sql_fieldLinkManager.fieldLinkManager();
        var d = m_sql_fieldLinkManager.descriptor(table1, 'id1', table2, 'id2', m_sql_fieldLink.Type.oneToMany);
        mgr1.addDescriptor(d);
        assert.equal(1, mgr1._descriptors.length);
    },
    testApply: function() {
        var id1 = m_sql_field.field('id1', m_sql_field.DataType.int);
        var table1 = m_sql_table.table('table1').field(id1);
