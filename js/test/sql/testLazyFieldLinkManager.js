...
var tests = {
    _name: 'testLazyFieldLinkManager',
    ...
    testCreate: function() {
        ...
        var d = m_sql_lazyFieldLink.lazyFieldLink(table1, 'id', table1, 'id1', table2, 'id2', m_sql_fieldLink.Type.oneToMany);
        mgr1.addLink(d);
        assert.equal(1, mgr1._links.length);
    },
    testApply: function() {
        var id1 = m_sql_field.field('id1', m_sql_field.DataType.int);
        var table1 = m_sql_table.table('table1').field(id1);
        ...
        var table2 = m_sql_table.table('table2').field(id2);
        var mgr1 = m_sql_lazyFieldLinkManager.lazyFieldLinkManager();
        var d = m_sql_lazyFieldLink.lazyFieldLink(table1, 'id1', table1, 'id1', table2, 'id2', m_sql_fieldLink.Type.oneToMany);
        mgr1.addLink(d);
        mgr1.apply();
