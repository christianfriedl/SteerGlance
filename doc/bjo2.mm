...
<node TEXT="Bugs" ID="ID_1933434283" CREATED="1435663737531" MODIFIED="1435664164850">
<node TEXT="&apos;sum&apos; is wrongfully in calcfield when coming back from saveField (only insert?)" ID="ID_1531816790" CREATED="1435663741886" MODIFIED="1435664102592"/>
</node>
